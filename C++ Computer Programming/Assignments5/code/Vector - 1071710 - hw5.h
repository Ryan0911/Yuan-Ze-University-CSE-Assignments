...
public:
   ...
   vector( const vector &right )
      : myData()
   {
	   int SizeLen = right.myData.myLast - right.myData.myFirst; //RightSize
	   int CapaLen = right.myData.myEnd - right.myData.myFirst; // RightCapacity
	   myData.myFirst = new value_type[SizeLen](); //宣告一個RightCapacity大小空間
